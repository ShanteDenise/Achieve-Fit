 ...
 * fix(schema): handle `{ timestamps: false ***REMOVED***` correctly #7088 #7074 [lineus](https://github.com/lineus)
 ...
 * fix(populate): handle multiple localFields + foreignFields using `localField: function() {***REMOVED***` syntax #5704
 ...
 * fix(update): make array op casting work with strict:false and {***REMOVED*** #6962 #6952 [lineus](https://github.com/lineus)
 ...
 * fix(update): cast `$addToSet: [1, 2]` -> `$addToSet: { $each: [1, 2] ***REMOVED***` #6086
 ...
 * fix(connection): allow connecting with { mongos: true ***REMOVED*** to handle query params #4032 [burtonjc](https://github.com/burtonjc)
...
==================
  ...
  * added; {mongoose,db***REMOVED***.modelNames()
  ...
  * fixed; specifying schema type edge case { path: [{type: "String" ***REMOVED***] ***REMOVED***
...
==================
  ...
  * fixed; display empty docs as {***REMOVED*** in log output #953 follow up
...
==================
  ...
  * docs; {g,s***REMOVED***etter introspection #777
...
==================
  ...
  * added; virtual {g,s***REMOVED***etter introspection (#1070)
...
=========================
  ...
  * removed; mongoose{connectSet,createSetConnection***REMOVED***. use connect,createConnection instead
  ...
  * fixed; array#{$pop,$shift***REMOVED*** mirror MongoDB behavior
  ...
  * fixed; Query#{update,remove***REMOVED***() works without callbacks (#788)
  ...
  * added; support for a configurable minimize option #to{Object,JSON***REMOVED***(option) (#848)
  * added; support for strict: `throws` [regality]
  * added; support for named schema types (#795)
  * added; to{Object,JSON***REMOVED*** schema options (#805)
  * added; findByIdAnd{Update,Remove***REMOVED***()
  * added; findOneAnd{Update,Remove***REMOVED***()
...
===================
  ...
  * deprecated; MongooseNumber#{inc, increment, decrement***REMOVED*** methods
...
===================
  ...
  * fixed; virtuals application of subdocs when using toObject({ virtuals: true ***REMOVED***) (#889)
...
===================
  ...
  * fixed; Query#{update,remove***REMOVED***() work without callbacks again (#788)
...
==================
  ...
  * Changed; Query#{run,exec***REMOVED*** return promises [aheckmann]
