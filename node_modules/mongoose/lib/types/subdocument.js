...
function Subdocument(value, fields, parent, skipId, options) {
  ...
  if (parent != null) {
    ...
    options = Object.assign({***REMOVED***, options, { isNew: parent.isNew ***REMOVED***);
  ***REMOVED***
 ...
 * @return {Promise***REMOVED*** resolved Promise
 * @api private
 */
  ...
  ***REMOVED***
  ...
  if (!options.suppressWarning) {
    console.warn('mongoose: calling `save()` on a subdoc does **not** save ' +
      ...
      'Use `subdoc.save({ suppressWarning: true ***REMOVED***)` to hide this warning ' +
...
Subdocument.prototype.invalidate = function(path, err, val) {
  ...
  ***REMOVED*** else if (err.kind === 'cast' || err.name === 'CastError') {
    throw err;
  ***REMOVED***
***REMOVED***;
 ...
 * @param {Function***REMOVED*** [callback] optional callback for compatibility with Document.prototype.remove
 */
 ...
 * on subdocuments.
 *
 * @param {EmbeddedDocument***REMOVED*** sub
 * @api private
 */
