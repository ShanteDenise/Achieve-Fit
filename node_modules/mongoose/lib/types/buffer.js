 ...
 *
 * @param {Buffer***REMOVED*** value
 * @param {String***REMOVED*** encode
...
function MongooseBuffer(value, encode, offset) {
  ...
  ***REMOVED*** // string, array or object { type: 'Buffer', data: [...] ***REMOVED***
...
MongooseBuffer.mixin = {
  ...
  ***REMOVED***,
   ...
   *
   * @return {Number***REMOVED*** The number of bytes copied.
   * @param {Buffer***REMOVED*** target
   * @method copy
   * @receiver MongooseBuffer
   */
