...
MongooseArray.mixin = {
  ...
  ***REMOVED***,
   ...
   *
   * @param {EmbeddedDocument***REMOVED*** embeddedDoc the embedded doc that invoked this method on the Array
   * @param {String***REMOVED*** embeddedPath the path which changed in the embeddedDoc
  ...
  ***REMOVED***,
   ...
   *
   * @param {Array***REMOVED*** op operation
  ...
  _registerAtomic: function(op, val) {
    ...
    ***REMOVED***
    ...
    if (this._atomics.$set ||
      ...
      this._atomics = {$set: this***REMOVED***;
      return this;
    ***REMOVED***
    ...
    ***REMOVED*** else if (op === '$pullDocs') {
      const pullOp = atomics['$pull'] || (atomics['$pull'] = {***REMOVED***);
      if (val[0] instanceof EmbeddedDocument) {
        selector = pullOp['$or'] || (pullOp['$or'] = []);
        Array.prototype.push.apply(selector, val.map(function(v) {
          return v.toObject({transform: false, virtuals: false***REMOVED***);
        ***REMOVED***));
      ***REMOVED***
        selector = pullOp['_id'] || (pullOp['_id'] = {$in: []***REMOVED***);
        selector['$in'] = selector['$in'].concat(val);
      ***REMOVED***
    ***REMOVED*** else if (op === '$push') {
      atomics.$push = atomics.$push || { $each: [] ***REMOVED***;
  ...
  ***REMOVED***,
  ...
  $__getAtomics: function() {
    ...
    const opts = Object.assign({***REMOVED***, internalToObjectOptions, { _isNested: true ***REMOVED***);
    ...
    ***REMOVED***
    ...
    while (i--) {
      ...
      ***REMOVED*** else if (val != null && Array.isArray(val.$each)) {
        val.$each = this.toObject.call(val.$each, opts);
      ***REMOVED*** else if (val.valueOf) {
        val = val.valueOf();
      ***REMOVED***

      if (op === '$addToSet') {
        val = {$each: val***REMOVED***;
      ***REMOVED***
  ...
  ***REMOVED***,
  ...
  push: function() {
    ...
    values = this._schema.applySetters(values, this._parent, undefined,
      undefined, { skipDocumentArrayCast: true ***REMOVED***);
  ...
  ***REMOVED***,
   ...
   *     doc.array.pull({ _id: 'someId' ***REMOVED***)
   *     doc.array.pull(36)
   *     doc.array.pull('tag 1', 'tag 2')
   *
   * To remove a document from a subdocument array we may pass an object with a matching `_id`.
   *
   *     doc.subdocs.push({ _id: 4815162342 ***REMOVED***)
   *     doc.subdocs.pull({ _id: 4815162342 ***REMOVED***) // removed
   *
      ...
      if (mem instanceof Document) {
        ...
        ***REMOVED***);
        if (some) {
          [].splice.call(cur, i, 1);
        ***REMOVED***
      ***REMOVED*** else if (~cur.indexOf.call(values, mem)) {
        [].splice.call(cur, i, 1);
      ***REMOVED***
    ***REMOVED***
  ...
  ***REMOVED***,
   ...
   *
   * @param {any***REMOVED*** [args...]
   * @return {Array***REMOVED*** the values that were added
   * @memberOf MongooseArray
   * @api public
   * @method addToSet
   */
  ...
  addToSet: function addToSet() {
    ...
    if (values[0] instanceof EmbeddedDocument) {
      type = 'doc';
    ***REMOVED*** else if (values[0] instanceof Date) {
      type = 'date';
    ***REMOVED***
  ...
  ***REMOVED***,
   ...
   *     var Doc = mongoose.model('Doc', new Schema({ array: [Number] ***REMOVED***));
   *
   *     var doc = new Doc({ array: [2,3,4] ***REMOVED***)
   *
   *     console.log(doc.array) // [2,3,4]
   *
   *     doc.array.set(1,"5");
  ...
  ***REMOVED***,
   ...
   *
   * @param {Object***REMOVED*** obj the item to look for
   * @return {Number***REMOVED***
   * @api public
   * @method indexOf
   * @memberOf MongooseArray
...
function _checkManualPopulation(arr, docs) {
  ...
  if (arr.length === 0 &&
    ...
    if (_isAllSubdocs(docs, ref)) {
      arr._parent.populated(arr._path, [], { model: docs[0].constructor ***REMOVED***);
    ***REMOVED***
  ***REMOVED***
***REMOVED***
