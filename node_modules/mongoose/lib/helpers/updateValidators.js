...
module.exports = function(query, schema, castedDoc, options) {
  ...
  let updatedKeys = {***REMOVED***;
  let updatedValues = {***REMOVED***;
  const isPull = {***REMOVED***;
  const arrayAtomicUpdates = {***REMOVED***;
              ...
              ***REMOVED***
              ...
              v.validate(function(err) {
                ...
                ***REMOVED***
                callback(null);
              ***REMOVED***);
            ***REMOVED***, context, { updateValidator: true ***REMOVED***);
          ***REMOVED***);
        ***REMOVED***
          validatorsToExecute.push(function(callback) {
