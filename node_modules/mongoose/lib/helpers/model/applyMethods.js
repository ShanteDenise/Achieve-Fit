  ...
  for (const method of Object.keys(schema.methods)) {
    ...
    ***REMOVED***
    if (schema.reserved[method] &&
        !get(schema, `methodOptions.${method***REMOVED***.suppressWarning`, false)) {
      console.warn(`mongoose: the method name "${method***REMOVED***" is used by mongoose ` +
        'internally, overwriting it may cause bugs. If you\'re sure you know ' +
        'what you\'re doing, you can suppress this error by using ' +
        `\`schema.method('${method***REMOVED***', fn, { suppressWarning: true ***REMOVED***)\`.`);
    ***REMOVED***
