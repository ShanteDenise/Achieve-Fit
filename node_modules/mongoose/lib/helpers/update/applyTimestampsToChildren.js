    ...
    ***REMOVED***
    if (update.$set != null) {
      ...
      for (key of keys) {
        ...
        ***REMOVED***
        if (Array.isArray(update.$set[key]) && path.$isMongooseDocumentArray) {
          ...
          if (timestamps) {
            ...
            ***REMOVED***
          ***REMOVED***
        ***REMOVED*** else if (update.$set[key] && path.$isSingleNested) {
          timestamps = path.schema.options.timestamps;
          if (timestamps) {
            createdAt = handleTimestampOption(timestamps, 'createdAt');
            updatedAt = handleTimestampOption(timestamps, 'updatedAt');
            ...
            ***REMOVED***
          ***REMOVED***
        ***REMOVED*** else if (path.$parentSchema !== schema && path.$parentSchema != null) {
        ...
        ***REMOVED*** else if (path.schema != null && path.schema != schema) {
          timestamps = path.schema.options.timestamps;
          createdAt = handleTimestampOption(timestamps, 'createdAt');
          updatedAt = handleTimestampOption(timestamps, 'updatedAt');
