...
function DocumentArray(key, schema, options, schemaOptions) {
  ...
  this.schema = schema;
  this.schemaOptions = schemaOptions || {***REMOVED***;
 ...
 * @param {Document***REMOVED*** document that triggers the casting
 * @api private
 */
...
DocumentArray.prototype.cast = function(value, doc, init, prev, options) {
  ...
  let subdoc;
  let i;
  const _opts = { transform: false, virtuals: false ***REMOVED***;
  ...
  ***REMOVED*** else if (value && value.isMongooseDocumentArray) {
  ...
  while (i--) {
    ...
    ***REMOVED***
    ...
    if ((value[i].$__) &&
      ...
      value[i] = value[i].toObject({ transform: false, virtuals: false ***REMOVED***);
    ***REMOVED***
 ...
 *
 * @param {DocumentArray***REMOVED*** array - the array to scope `fields` paths
 * @param {Object|undefined***REMOVED*** fields - the root fields selected in the query
 * @param {Boolean|undefined***REMOVED*** init - if we are being created part of a query result
 */
