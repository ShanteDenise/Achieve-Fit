...
describe('filter', function() {
  it('returns clone with only hooks that match `fn()`', function() {
    ...
    k1.pre('update', { document: true ***REMOVED***, f1);
    k1.pre('update', { query: true ***REMOVED***, f2);
    k1.pre('remove', { document: true ***REMOVED***, f3);

    k1.post('update', { document: true ***REMOVED***, f1);
    k1.post('update', { query: true ***REMOVED***, f2);
    k1.post('remove', { document: true ***REMOVED***, f3);
