 ...
 *
 * @param {Object***REMOVED*** started A high resolution timestamp created from `process.hrtime()`
 * @returns {Number***REMOVED*** The duration in milliseconds
 */
 ...
 *
 * @param {EventEmitter***REMOVED*** listener the EventEmitter to listen to the events from
 * @param {EventEmitter***REMOVED*** emitter the EventEmitter to relay the events to
 */
...
const retrieveEJSON = function() {
  ...
  ***REMOVED*** catch (error) {***REMOVED*** // eslint-disable-line
  if (!EJSON) {
    EJSON = {
      parse: noEJSONError,
 ...
 *
 * @param {Server***REMOVED*** [server] to check against
 * @param {object***REMOVED*** [cmd] object where collation may be specified
