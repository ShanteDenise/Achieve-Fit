...
var WireProtocol = function() {***REMOVED***;
...
var executeWrite = function(pool, bson, type, opsField, ns, ops, options, callback) {
  ...
  ***REMOVED***
  ...
  // Options object
  var opts = { command: true ***REMOVED***;
  if (typeof options.session !== 'undefined') opts.session = options.session;
  var queryOptions = { checkKeys: false, numberToSkip: 0, numberToReturn: 1 ***REMOVED***;
...
WireProtocol.prototype.getMore = function(
  ...
  var getMore = new GetMore(bson, ns, cursorState.cursorId, { numberToReturn: batchSize ***REMOVED***);
...
WireProtocol.prototype.command = function(bson, ns, cmd, cursorState, topology, options) {
  ...
  ***REMOVED*** else if (cursorState.cursorId != null) {
    return;
  ***REMOVED*** else if (cmd) {
