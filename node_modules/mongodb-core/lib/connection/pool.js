 ...
 * @param {number***REMOVED*** [options.size=5] Max server connection pool size
 * @param {number***REMOVED*** [options.minSize=0] Minimum server connection pool size
 ...
 * @param {number***REMOVED*** [options.monitoringSocketTimeout=30000] TCP Socket timeout setting for replicaset monitoring socket
 ...
 * @param {boolean***REMOVED*** [options.rejectUnauthorized=false] Reject unauthorized server certificates
 ...
 * @return {Pool***REMOVED*** A cursor instance
 */
 ...
 * @method
 * @return {Number***REMOVED*** The number of socket available.
 */
 ...
 * @method
 * @return {Connection[]***REMOVED*** The pool connections
 */
 ...
 * @method
 * @param {string***REMOVED*** dbName The database name
 * @param {authResultCallback***REMOVED*** callback A callback function
 */
  ...
  for (var i = 0; i < connections.length; i++) {
    write(self)(
      ...
      new Query(
        ...
        f('%s.$cmd', dbName),
        { logout: 1 ***REMOVED***,
        { numberToSkip: 0, numberToReturn: 1 ***REMOVED***
      ),
      function(err) {
        count = count - 1;
        if (err) error = err;
  ...
  function checkStatus() {
    ...
    if (self.queue.length === 0) {
      ...
      ***REMOVED***
      ...
      // ***REMOVED*** else if (self.queue.length > 0 && !this.reconnectId) {
    ***REMOVED***
...
Pool.prototype.write = function(commands, options, cb) {
  ...
  ***REMOVED***
  ...
  if (hasSessionSupport(this.topology)) {
    let sessionOptions = {***REMOVED***;
    if (this.topology.clusterTime) {
      sessionOptions = { $clusterTime: this.topology.clusterTime ***REMOVED***;
    ***REMOVED***
...
function flushMonitoringOperations(queue) {
  for (var i = 0; i < queue.length; i++) {
    if (queue[i].monitoring) {
      ...
      queue.splice(i, 1);
      workItem.cb(
        new MongoError({ message: 'no connection available for monitoring', driver: true ***REMOVED***)
      );
    ***REMOVED***
  ***REMOVED***
***REMOVED***
      ...
      while (true) {
        ...
        ***REMOVED***
        ...
        if (connection.isConnected()) {
          ...
          ***REMOVED*** else if (writeSuccessful === false) {
