 ...
 * @class
 * @param {array***REMOVED*** seedlist A list of seeds for the replicaset
 * @param {boolean***REMOVED*** options.setName The Replicaset set name
 * @param {boolean***REMOVED*** [options.secondaryOnlyConnectionAllowed=false] Allow connection to a secondary only replicaset
 * @param {number***REMOVED*** [options.haInterval=10000] The High availability period for replicaset inquiry
 * @param {boolean***REMOVED*** [options.emitError=false] Server will emit errors events
 * @param {Cursor***REMOVED*** [options.cursorFactory=Cursor] The cursor factory class used for all query cursors
 * @param {number***REMOVED*** [options.size=5] Server connection pool size
 * @param {boolean***REMOVED*** [options.keepAlive=true] TCP Connection keep alive enabled
 * @param {number***REMOVED*** [options.keepAliveInitialDelay=0] Initial delay before TCP keep alive enabled
 * @param {boolean***REMOVED*** [options.noDelay=true] TCP Connection no delay
 * @param {number***REMOVED*** [options.connectionTimeout=10000] TCP Connection timeout setting
 * @param {number***REMOVED*** [options.socketTimeout=0] TCP Socket timeout setting
 ...
 * @param {string***REMOVED*** [options.servername=null] String containing the server name requested via TLS SNI.
 ...
 * @param {number***REMOVED*** [options.pingInterval=5000] Ping interval to check the response time to the different servers
 * @param {number***REMOVED*** [options.localThresholdMS=15] Cutoff latency point in MS for Replicaset member selection
 * @param {boolean***REMOVED*** [options.domainsEnabled=false] Enable the wrapping of the callback in the current domain, disabled by default to avoid perf hit.
 * @param {boolean***REMOVED*** [options.monitorCommands=false] Enable command monitoring for this topology
 * @return {ReplSet***REMOVED*** A cursor instance
 ...
 * @property {string***REMOVED*** type the topology type.
 * @property {string***REMOVED*** parserType the parser type used (c++ or js).
 */
...
function rexecuteOperations(self) {
  ...
  ***REMOVED*** else if (self.s.replicaSetState.hasPrimary() && self.s.disconnectHandler) {
    self.s.disconnectHandler.execute({ executePrimary: true ***REMOVED***);
  ***REMOVED*** else if (self.s.replicaSetState.hasSecondary() && self.s.disconnectHandler) {
    self.s.disconnectHandler.execute({ executeSecondary: true ***REMOVED***);
  ***REMOVED***
***REMOVED***
  ...
  var _handleEvent = function(self, event) {
    return function(err) {
      ...
      if (self.state === DESTROYED || self.state === UNREFERENCED) {
        return this.destroy({ force: true ***REMOVED***);
      ***REMOVED***

      if (event === 'connect' && !self.authenticating) {
        // Destroyed
        if (self.state === DESTROYED || self.state === UNREFERENCED) {
          return _self.destroy({ force: true ***REMOVED***);
        ***REMOVED***
          ...
          ***REMOVED***
          ...
          if (result) {
            ...
            ***REMOVED***
            ...
            monitorServer(_self.lastIsMaster().me, self, {***REMOVED***);

            // Rexecute any stalled operation
            rexecuteOperations(self);
          ***REMOVED***
            _self.destroy({ force: true ***REMOVED***);
          ***REMOVED***
        ***REMOVED***);
      ***REMOVED*** else if (event === 'connect' && self.authenticating) {
        this.destroy({ force: true ***REMOVED***);
    ...
    setTimeout(function() {
      ...
      ***REMOVED***
      ...
      var server = new Server(
        Object.assign({***REMOVED***, self.s.options, {
...
var pingServer = function(self, server, cb) {
  ...
  emitSDAMEvent(self, 'serverHeartbeatStarted', { connectionId: server.name ***REMOVED***);
  ...
  server.command(
    ...
    ***REMOVED***,
    function(err, r) {
      if (self.state === DESTROYED || self.state === UNREFERENCED) {
        server.destroy({ force: true ***REMOVED***);
        return cb(err, r);
      ***REMOVED***
      ...
      ***REMOVED***
        ...
        ***REMOVED*** else if (server.lastIsMasterMS) {
      ...
      ***REMOVED***
      ...
      if (!self.s.replicaSetState.hasPrimary() && !self.s.options.secondaryOnlyConnectionAllowed) {
        ...
        ***REMOVED***
        ...
        return self.destroy({ force: true ***REMOVED***);
      ***REMOVED*** else if (
        !self.s.replicaSetState.hasSecondary() &&
        self.s.options.secondaryOnlyConnectionAllowed
      ) {
...
function handleEvent(self, event) {
  return function() {
    ...
    ***REMOVED*** else if (!self.s.replicaSetState.hasPrimary()) {
      stateTransition(self, DISCONNECTED);
    ***REMOVED***
  ...
  return function() {
    ...
    ***REMOVED***
    ...
    if (event === 'connect') {
      ...
      applyAuthenticationContexts(self, _this, function() {
        // Destroy the instance
        if (self.state === DESTROYED || self.state === UNREFERENCED) {
          return _this.destroy({ force: true ***REMOVED***);
        ***REMOVED***
          ...
          ***REMOVED***
          ...
          if (shouldTriggerConnect(self)) {
            ...
            ***REMOVED***);
            ...
            topologyMonitor(self, {***REMOVED***);
          ***REMOVED***
        ***REMOVED*** else if (result instanceof MongoError) {
          _this.destroy({ force: true ***REMOVED***);
          self.destroy({ force: true ***REMOVED***);
    ...
    ***REMOVED***
    ...
    if (self.s.connectingServers.length === 0 && self.state === CONNECTING) {
      topologyMonitor(self, { haInterval: 1 ***REMOVED***);
    ***REMOVED***
  ***REMOVED***;
***REMOVED***
 ...
 * @method
 * @param {array***REMOVED*** [options.auth=null] Array of auth options to apply on connect
 */
ReplSet.prototype.connect = function(options) {
  var self = this;
  // Add any connect level options to the internal state
  this.s.connectOptions = options || {***REMOVED***;
  // Set connecting state
  stateTransition(this, CONNECTING);
  // Create server instances
  var servers = this.s.seedlist.map(function(x) {
    return new Server(
      Object.assign({***REMOVED***, self.s.options, x, {
        authProviders: self.authProviders,
        reconnect: false,
        monitoring: false,
        parent: self,
  ...
  ***REMOVED***
  ...
  emitSDAMEvent(this, 'topologyOpening', { topologyId: this.id ***REMOVED***);
 ...
 * @param {boolean***REMOVED*** [options.force=false] Force destroy the pool
 * @method
 */
ReplSet.prototype.destroy = function(options) {
  ...
  ***REMOVED***
  ...
  emitSDAMEvent(this, 'topologyClosed', { topologyId: this.id ***REMOVED***);
***REMOVED***;
 ...
 * @method
 * @param {ReadPreference***REMOVED*** [options.readPreference] Specify read preference if command supports it
...
function executeWriteOperation(args, options, callback) {
  ...
  ***REMOVED***
  ...
  if (!self.s.replicaSetState.hasPrimary()) {
    ...
    ***REMOVED*** else if (!willRetryWrite) {
  ...
  ***REMOVED***
  ...
  const handler = (err, result) => {
    ...
    ***REMOVED***
    ...
    if (willRetryWrite) {
      const newArgs = Object.assign({***REMOVED***, args, { retrying: true ***REMOVED***);
      return executeWriteOperation(newArgs, options, callback);
    ***REMOVED***

    // Per SDAM, remove primary from replicaset
    if (self.s.replicaSetState.primary) {
      self.s.replicaSetState.remove(self.s.replicaSetState.primary, { force: true ***REMOVED***);
    ***REMOVED***
 ...
 * @param {array***REMOVED*** ops An array of documents to insert
 * @param {boolean***REMOVED*** [options.ordered=true] Execute in order or out of order
 * @param {object***REMOVED*** [options.writeConcern={***REMOVED***] Write concern for the operation
 * @param {Boolean***REMOVED*** [options.serializeFunctions=false] Specify if functions on an object should be serialized.
 * @param {Boolean***REMOVED*** [options.ignoreUndefined=false] Specify if the BSON serializer should ignore undefined fields.
 * @param {ClientSession***REMOVED*** [options.session=null] Session to use for the operation
 * @param {boolean***REMOVED*** [options.retryWrites] Enable retryable writes for this operation
 * @param {opResultCallback***REMOVED*** callback A callback function
 */
ReplSet.prototype.insert = function(ns, ops, options, callback) {
  // Execute write operation
  executeWriteOperation({ self: this, op: 'insert', ns, ops ***REMOVED***, options, callback);
***REMOVED***;
 ...
 * @method
 * @param {string***REMOVED*** ns The MongoDB fully qualified namespace (ex: db1.collection1)
 * @param {array***REMOVED*** ops An array of updates
 * @param {boolean***REMOVED*** [options.ordered=true] Execute in order or out of order
 * @param {object***REMOVED*** [options.writeConcern={***REMOVED***] Write concern for the operation
 * @param {Boolean***REMOVED*** [options.serializeFunctions=false] Specify if functions on an object should be serialized.
 * @param {Boolean***REMOVED*** [options.ignoreUndefined=false] Specify if the BSON serializer should ignore undefined fields.
...
ReplSet.prototype.update = function(ns, ops, options, callback) {
  // Execute write operation
  executeWriteOperation({ self: this, op: 'update', ns, ops ***REMOVED***, options, callback);
***REMOVED***;
 ...
 * @method
 * @param {string***REMOVED*** ns The MongoDB fully qualified namespace (ex: db1.collection1)
 * @param {array***REMOVED*** ops An array of removes
 * @param {boolean***REMOVED*** [options.ordered=true] Execute in order or out of order
 * @param {object***REMOVED*** [options.writeConcern={***REMOVED***] Write concern for the operation
 * @param {Boolean***REMOVED*** [options.serializeFunctions=false] Specify if functions on an object should be serialized.
 * @param {Boolean***REMOVED*** [options.ignoreUndefined=false] Specify if the BSON serializer should ignore undefined fields.
...
ReplSet.prototype.remove = function(ns, ops, options, callback) {
  // Execute write operation
  executeWriteOperation({ self: this, op: 'remove', ns, ops ***REMOVED***, options, callback);
***REMOVED***;
 ...
 * @method
 * @param {string***REMOVED*** ns The MongoDB fully qualified namespace (ex: db1.collection1)
 * @param {object***REMOVED*** cmd The command hash
 * @param {ReadPreference***REMOVED*** [options.readPreference] Specify read preference if command supports it
 * @param {Connection***REMOVED*** [options.connection] Specify connection object to execute command against
 * @param {Boolean***REMOVED*** [options.serializeFunctions=false] Specify if functions on an object should be serialized.
 * @param {Boolean***REMOVED*** [options.ignoreUndefined=false] Specify if the BSON serializer should ignore undefined fields.
 * @param {ClientSession***REMOVED*** [options.session=null] Session to use for the operation
 * @param {opResultCallback***REMOVED*** callback A callback function
...
ReplSet.prototype.command = function(ns, cmd, options, callback) {
  if (typeof options === 'function') {
    (callback = options), (options = {***REMOVED***), (options = options || {***REMOVED***);
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  const cb = (err, result) => {
    ...
    ***REMOVED***
    ...
    if (willRetryWrite) {
      const newOptions = Object.assign({***REMOVED***, options, { retrying: true ***REMOVED***);
      return this.command(ns, cmd, newOptions, callback);
    ***REMOVED***

    // Per SDAM, remove primary from replicaset
    if (this.s.replicaSetState.primary) {
      this.s.replicaSetState.remove(this.s.replicaSetState.primary, { force: true ***REMOVED***);
    ***REMOVED***
 ...
 * @method
 * @param {string***REMOVED*** mechanism The Auth mechanism we are invoking
 * @param {string***REMOVED*** db The db we are invoking the mechanism against
 * @param {...object***REMOVED*** param Parameters for the specific mechanism
 * @param {authResultCallback***REMOVED*** callback A callback function
 */
ReplSet.prototype.auth = function(mechanism, db) {
  ...
  ***REMOVED***
  ...
  if (!this.isConnected() && self.s.disconnectHandler != null) {
    if (!self.s.replicaSetState.hasPrimary() && !self.s.options.secondaryOnlyConnectionAllowed) {
      return self.s.disconnectHandler.add('auth', db, allArgs, {***REMOVED***, callback);
    ***REMOVED*** else if (
      !self.s.replicaSetState.hasSecondary() &&
      self.s.options.secondaryOnlyConnectionAllowed
    ) {
  ...
  function auth(server) {
    ...
    var finalArguments = argsWithoutCallback.concat([
      function(err) {
        count = count - 1;
        // Save all the errors
        if (err) errors.push({ name: server.name, err: err ***REMOVED***);
        // We are done
        if (count === 0) {
          // Auth is done
 ...
 * @method
 * @param {string***REMOVED*** db The db we are logging out from
 * @param {authResultCallback***REMOVED*** callback A callback function
 */
  ...
  ***REMOVED***);
  ...
  function logoutServer(_server, cb) {
    _server.logout(dbName, function(err) {
      if (err) errors.push({ name: _server.name, err: err ***REMOVED***);
      cb();
    ***REMOVED***);
  ***REMOVED***
 ...
 * @method
 * @param {string***REMOVED*** ns The MongoDB fully qualified namespace (ex: db1.collection1)
 * @param {object|Long***REMOVED*** cmd Can be either a command returning a cursor or a cursorId
 * @param {object***REMOVED*** [options] Options for the cursor
 * @param {object***REMOVED*** [options.batchSize=0] Batchsize for the operation
 * @param {array***REMOVED*** [options.documents=[]] Initial documents list for cursor
 * @param {ReadPreference***REMOVED*** [options.readPreference] Specify read preference if command supports it
 * @param {Boolean***REMOVED*** [options.serializeFunctions=false] Specify if functions on an object should be serialized.
 * @param {Boolean***REMOVED*** [options.ignoreUndefined=false] Specify if the BSON serializer should ignore undefined fields.
 * @param {ClientSession***REMOVED*** [options.session=null] Session to use for the operation
 * @param {object***REMOVED*** [options.topology] The internal topology of the created cursor
 * @returns {Cursor***REMOVED***
 */
 ...
 * @param {string***REMOVED*** type The type of member that left (primary|secondary|arbiter)
 * @param {Server***REMOVED*** server The server object that left
 */
 ...
 * @type {function***REMOVED***
 * @param {string***REMOVED*** type The type of member that joined (primary|secondary|arbiter)
 * @param {Server***REMOVED*** server The server object that joined
 */
