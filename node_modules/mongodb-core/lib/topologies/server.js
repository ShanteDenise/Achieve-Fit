...
function getSaslSupportedMechs(options) {
  ...
  ***REMOVED***
  ...
  return { saslSupportedMechs: `${authSource***REMOVED***.${user***REMOVED***` ***REMOVED***;
***REMOVED***
 ...
 * @class
 * @param {boolean***REMOVED*** [options.reconnect=true] Server will attempt to reconnect on loss of connection
 * @param {number***REMOVED*** [options.reconnectTries=30] Server attempt to reconnect #times
 * @param {number***REMOVED*** [options.reconnectInterval=1000] Server will wait # milliseconds between retries
 * @param {number***REMOVED*** [options.monitoring=true] Enable the server state monitoring (calling ismaster at monitoringInterval)
 * @param {number***REMOVED*** [options.monitoringInterval=5000] The interval of calling ismaster when monitoring is enabled.
 ...
 * @param {string***REMOVED*** [options.appname=null] Application name, passed in on ismaster call and logged in mongod server logs. Maximum size 128 bytes.
 ...
 * @return {Server***REMOVED*** A cursor instance
...
var Server = function(options) {
  ...
  this.s = {
    ...
    // Topology id
    topologyId: -1,
    compression: { compressors: createCompressionInfo(options) ***REMOVED***,
...
function monitoringProcess(self) {
  return function() {
    ...
    // Query options
    var queryOptions = { numberToSkip: 0, numberToReturn: -1, checkKeys: false, slaveOk: true ***REMOVED***;
    // Create a query instance
    var query = new Query(self.s.bson, 'admin.$cmd', { ismaster: true ***REMOVED***, queryOptions);
    // Get start time
...
var eventHandler = function(self, event) {
  return function(err) {
    ...
    if (self.s.logger.isInfo()) {
      var object = err instanceof MongoError ? JSON.stringify(err) : {***REMOVED***;
      self.s.logger.info(
    ...
    ***REMOVED***
    ...
    if (event === 'connect') {
      ...
      var query = new Query(
        ...
        'admin.$cmd',
        Object.assign(
          { ismaster: true, client: self.clientInfo, compression: compressors ***REMOVED***,
    ...
    ***REMOVED*** else if (
      ...
      if (
        ...
        if (!self.s.inTopology) {
          self.emit('topologyOpening', { topologyId: self.id ***REMOVED***);
        ***REMOVED***
...
Server.prototype.connect = function(options) {
  ...
  ***REMOVED***
  ...
  // Create a pool
  self.s.pool = new Pool(this, Object.assign(self.s.options, options, { bson: this.s.bson ***REMOVED***));
  ...
  // Emit toplogy opening event if not in topology
  if (!self.s.inTopology) {
    this.emit('topologyOpening', { topologyId: self.id ***REMOVED***);
  ***REMOVED***
...
Server.prototype.getDescription = function() {
  var ismaster = this.ismaster || {***REMOVED***;
  var description = {
 ...
 * @param {Boolean***REMOVED*** [options.checkKeys=false] Specify if the bson parser should validate keys.
 * @param {Boolean***REMOVED*** [options.ignoreUndefined=false] Specify if the BSON serializer should ignore undefined fields.
 * @param {Boolean***REMOVED*** [options.fullResult=false] Return the full envelope instead of just the result document.
...
Server.prototype.command = function(ns, cmd, options, callback) {
  ...
  ***REMOVED***
  ...
  // Clone the options
  options = Object.assign({***REMOVED***, options, { wireProtocolCommand: false ***REMOVED***);
  ...
  if (collationNotSupported(this, cmd)) {
    return callback(new MongoError(`server ${this.name***REMOVED*** does not support collation`));
  ***REMOVED***

  // Are we executing against a specific topology
  var topology = options.topology || {***REMOVED***;
  // Create the query object
  var query = self.wireProtocolHandler.command(self.s.bson, ns, cmd, {***REMOVED***, topology, options);
...
Server.prototype.auth = function(mechanism, db) {
  ...
  ***REMOVED***
  ...
  // If we are not connected or have a disconnectHandler specified
  if (disconnectHandler(self, 'auth', db, args, {***REMOVED***, callback)) {
    return;
  ***REMOVED***
 ...
 * @method
 * @param {Server***REMOVED*** server Server to compare equality against
 * @return {boolean***REMOVED***
 */
 ...
 * @method
 * @param {boolean***REMOVED*** [options.emitClose=false] Emit close event on destroy
 * @param {boolean***REMOVED*** [options.emitDestroy=false] Emit destroy event on destroy
...
Server.prototype.destroy = function(options) {
  ...
  ***REMOVED***);
  ...
  if (self.listeners('topologyClosed').length > 0 && !self.s.inTopology) {
    self.emit('topologyClosed', { topologyId: self.id ***REMOVED***);
  ***REMOVED***
