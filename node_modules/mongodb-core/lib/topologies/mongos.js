 ...
 *
 * var server = new Mongos([{host: 'localhost', port: 30000***REMOVED***]);
 ...
 * @param {number***REMOVED*** [options.haInterval=5000] The High availability period for replicaset inquiry
 ...
 * @param {number***REMOVED*** [options.localThresholdMS=15] Cutoff latency point in MS for MongoS proxy selection
 * @param {boolean***REMOVED*** [options.noDelay=true] TCP Connection no delay
 * @param {number***REMOVED*** [options.connectionTimeout=1000] TCP Connection timeout setting
 ...
 * @return {Mongos***REMOVED*** A cursor instance
    ...
    ***REMOVED***
    ...
    if (self.connectingProxies.length === 0) {
      ...
      if (self.connectedProxies.length > 0 && self.state === CONNECTING) {
        ...
        self.emit('all', self);
      ***REMOVED*** else if (self.disconnectedProxies.length === 0) {
        // Print warning if we did not find a mongos proxy
        if (self.s.logger.isWarn()) {
          self.s.logger.warn(
      ...
      ***REMOVED***
      ...
      // Topology monitor
      topologyMonitor(self, { firstConnect: true ***REMOVED***);
    ***REMOVED***
  ***REMOVED***;
***REMOVED***
  ...
  self.haTimeoutId = setTimeout(function() {
    ...
    ***REMOVED***
    ...
    function pingServer(_self, _server, cb) {
      ...
      emitSDAMEvent(self, 'serverHeartbeatStarted', { connectionId: _server.name ***REMOVED***);
      ...
      ***REMOVED***
      ...
      return reconnectProxies(self, self.disconnectedProxies, function() {
        ...
        if (self.state === CONNECTING && options.firstConnect) {
          ...
          self.emit('fullsetup', self);
          self.emit('all', self);
        ***REMOVED*** else if (self.isConnected()) {
          self.emit('reconnect', self);
        ***REMOVED*** else if (!self.isConnected() && self.listeners('close').length > 0) {
          self.emit('close', self);
        ***REMOVED***
  ...
  ***REMOVED***
  ...
  const cb = (err, result) => {
    ...
    ***REMOVED***
    ...
    if (willRetryWrite) {
      const newOptions = Object.assign({***REMOVED***, clonedOptions, { retrying: true ***REMOVED***);
 ...
 * @event Mongos#left
 * @type {Mongos***REMOVED***
 * @param {string***REMOVED*** type The type of member that left (mongos)
