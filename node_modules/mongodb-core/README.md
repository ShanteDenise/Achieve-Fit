...
server.on('connect', function(_server) {
  ...
  _server.command('system.$cmd', {ismaster: true***REMOVED***, function(err, result) {

    // Perform a document insert
    _server.insert('myproject.inserts1', [{a:1***REMOVED***, {a:2***REMOVED***], {
      writeConcern: {w:1***REMOVED***, ordered:true
    ***REMOVED***, function(err, results) {
      ...
      _server.update('myproject.inserts1', [{
        q: {a: 1***REMOVED***, u: {'$set': {b:1***REMOVED******REMOVED***
      ***REMOVED***], {
        writeConcern: {w:1***REMOVED***, ordered:true
      ***REMOVED***, function(err, results) {
        assert.equal(null, err);
          ...
          ***REMOVED***);
          ...
          cursor.next(function(err, doc) {
            ...
            _server.command("system.$cmd"
              , {ismaster: true***REMOVED***, function(err, result) {
                assert.equal(null, err)
                _server.destroy();              
            ***REMOVED***);
          ***REMOVED***);
