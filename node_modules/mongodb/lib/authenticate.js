...
var authenticate = function(client, username, password, options, callback) {
  ...
  ***REMOVED*** else if (authMechanism === 'GSSAPI') {
    ...
    ***REMOVED***
      ...
      ***REMOVED***);
    ***REMOVED***
  ***REMOVED*** else if (authMechanism === 'DEFAULT') {
