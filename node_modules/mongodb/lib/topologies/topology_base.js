...
var Store = function(topology, storeOptions) {
  var self = this;
  var storedOps = [];
  storeOptions = storeOptions || { force: false, bufferMaxEntries: -1 ***REMOVED***;
...
Store.prototype.add = function(opType, ns, ops, options, callback) {
  if (this.s.storeOptions.force) {
    return callback(MongoError.create({ message: 'db closed by application', driver: true ***REMOVED***));
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  this.s.storedOps.push({ t: opType, n: ns, o: ops, op: options, c: callback ***REMOVED***);
***REMOVED***;
...
Store.prototype.addObjectAndMethod = function(opType, object, method, params, callback) {
  ...
  ***REMOVED***
  ...
  this.s.storedOps.push({ t: opType, m: method, o: object, p: params, c: callback ***REMOVED***);
***REMOVED***;
...
Store.prototype.flush = function(err) {
  while (this.s.storedOps.length > 0) {
    this.s.storedOps
      ...
      .c(
        err ||
          MongoError.create({ message: f('no connection available for operation'), driver: true ***REMOVED***)
      );
  ***REMOVED***
***REMOVED***;
