...
const legacyParse = deprecate(
  ...
  'current URL string parser is deprecated, and will be removed in a future version. ' +
    'To use the new parser, pass option { useNewUrlParser: true ***REMOVED*** to MongoClient.connect.'
);
  ...
  if (mongoClient instanceof MongoClient) {
    monitoringEvents.forEach(event => {
      topology.on(event, (object1, object2) => {
        if (event === 'open') {
          collectedEvents.push({ event: event, object1: mongoClient ***REMOVED***);
        ***REMOVED***
          collectedEvents.push({ event: event, object1: object1, object2: object2 ***REMOVED***);
        ***REMOVED***
      ***REMOVED***);
    ***REMOVED***);
  ***REMOVED***
 ...
 *
 * @method
 * @param {MongoClient***REMOVED*** mongoClient The MongoClient instance with which to connect.
 * @param {string***REMOVED*** url The connection URI string
 * @param {object***REMOVED*** [options] Optional settings. See MongoClient.prototype.connect for a list of options.
 * @param {MongoClient~connectCallback***REMOVED*** [callback] The command result callback
 */
function connect(mongoClient, url, options, callback) {
  ...
  ***REMOVED***
  ...
  parseFn(url, options, (err, _object) => {
    ...
    ***REMOVED*** else if (object.servers.length > 1) {
      return createTopology(
        mongoClient,
        'mongos',
        _finalOptions,
...
function createTopology(mongoClient, topologyType, options, callback) {
  ...
  const translationOptions = {***REMOVED***;
  ...
  ***REMOVED*** else if (topologyType === 'replicaset') {
...
function createUnifiedOptions(finalOptions, options) {
  ...
  for (const name in options) {
    ...
    ***REMOVED*** else if (childOptions.indexOf(name.toLowerCase()) !== -1) {
...
function legacyTransformUrlOptions(object) {
  return mergeOptions(createUnifiedOptions({***REMOVED***, object), object, false);
***REMOVED***
 ...
 *
 * @method
 * @param {MongoClient***REMOVED*** mongoClient The MongoClient instance on which to logout.
 * @param {object***REMOVED*** [options] Optional settings. See MongoClient.prototype.logout for a list of options.
...
function transformUrlOptions(_object) {
  let object = Object.assign({ servers: _object.hosts ***REMOVED***, _object.options);
  ...
  ***REMOVED***
  ...
  if (object.readconcernlevel) {
    object.readConcern = { level: object.readconcernlevel ***REMOVED***;
  ***REMOVED***
...
function translateOptions(options, translationOptions) {
  translationOptions = Object.assign({***REMOVED***, { createServers: true ***REMOVED***, translationOptions);
  ...
  for (const name in options) {
    ...
    ***REMOVED***
    ...
    if (_validOptions.indexOf(name) === -1 && options.validateOptions) {
      return new MongoError(`option ${name***REMOVED*** is not supported`);
    ***REMOVED*** else if (_validOptions.indexOf(name) === -1) {
      console.warn(`the options [${name***REMOVED***] is not supported`);
    ***REMOVED***

    if (legacyOptionNames.indexOf(name) !== -1) {
      console.warn(
        `the server/replset/mongos/db options are deprecated, ` +
          `all their options are supported at the top level of the options object [${validOptionNames***REMOVED***]`
      );
    ***REMOVED***
  ***REMOVED***
***REMOVED***

module.exports = { connectOp, logout, validOptions ***REMOVED***;
