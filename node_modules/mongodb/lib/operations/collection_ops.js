...
//
//     if (aggObj == null) {
//       var newObj = Object.extend({***REMOVED***, key);
 ...
 *
 * @method
 * @param {Collection***REMOVED*** a Collection instance.
 * @param {object[]***REMOVED*** operations Bulk operations to perform.
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.bulkWrite for a list of options.
...
function bulkWrite(coll, operations, options, callback) {
  ...
  ***REMOVED***
  ...
  finalOptions = applyWriteConcern(finalOptions, { db: coll.s.db, collection: coll ***REMOVED***, options);

  const writeCon = finalOptions.writeConcern ? finalOptions.writeConcern : {***REMOVED***;
  ...
  ***REMOVED***
  ...
  bulk.execute(writeCon, finalOptions, (err, r) => {
    ...
    ***REMOVED***
    ...
    r.upsertedIds = {***REMOVED***;
    r.insertedIds = {***REMOVED***;
 ...
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.count for a list of options.
...
function countDocuments(coll, query, options, callback) {
  ...
  const pipeline = [{ $match: query ***REMOVED***];

  // Add skip and limit if defined
  if (typeof skip === 'number') {
    pipeline.push({ $skip: skip ***REMOVED***);
  ***REMOVED***

  if (typeof limit === 'number') {
    pipeline.push({ $limit: limit ***REMOVED***);
  ***REMOVED***

  pipeline.push({ $group: { _id: null, n: { $sum: 1 ***REMOVED*** ***REMOVED*** ***REMOVED***);
 ...
 *
 * @method
 * @param {collectionOrCursor***REMOVED*** an instance of a collection or cursor
 * @param {object***REMOVED*** query The query for the count.
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.count and Cursor.prototype.count for a list of options.
 */
function buildCountCommand(collectionOrCursor, query, options) {
  ...
  ***REMOVED***;
  ...
  if (collectionOrCursor.s.numberOfRetries) {
    ...
    ***REMOVED*** else if (collectionOrCursor.s.cmd.hint) {
 ...
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.createIndex for a list of options.
 ...
 * @param {Object***REMOVED*** [options] Optional settings. See Collection.prototype.createIndexes for a list of options.
 * @param {Collection~resultCallback***REMOVED*** [callback] The command result callback
 */
    ...
    if (indexSpecs[i].name == null) {
      ...
      ***REMOVED***
      ...
      for (let name in indexSpecs[i].key) {
        keys.push(`${name***REMOVED***_${indexSpecs[i].key[name]***REMOVED***`);
      ***REMOVED***
...
function deleteCallback(err, r, callback) {
  ...
  if (r == null) return callback(null, { result: { ok: 1 ***REMOVED*** ***REMOVED***);
 ...
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.deleteMany for a list of options.
 ...
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.deleteOne for a list of options.
 * @param {Collection~deleteWriteOpCallback***REMOVED*** [callback] The command result callback
 */
 ...
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.distinct for a list of options.
 * @param {Collection~resultCallback***REMOVED*** [callback] The command result callback
 */
function distinct(coll, key, query, options, callback) {
  ...
  ***REMOVED***;
  ...
  options.readPreference = resolveReadPreference(options, { db: coll.s.db, collection: coll ***REMOVED***);
 ...
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.dropIndex for a list of options.
 * @param {Collection~resultCallback***REMOVED*** [callback] The command result callback
 */
function dropIndex(coll, indexName, options, callback) {
  // Delete index command
  const cmd = { dropIndexes: coll.s.name, index: indexName ***REMOVED***;

  // Decorate command with writeConcern if supported
  applyWriteConcern(cmd, { db: coll.s.db, collection: coll ***REMOVED***, options);
 ...
 * @method
 * @param {Collection***REMOVED*** a Collection instance.
 * @param {Object***REMOVED*** [options] Optional settings. See Collection.prototype.dropIndexes for a list of options.
 * @param {Collection~resultCallback***REMOVED*** [callback] The command result callback
 */
 ...
 * @param {Collection***REMOVED*** a Collection instance.
 * @param {(string|object)***REMOVED*** fieldOrSpec Defines the index.
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.ensureIndex for a list of options.
 * @param {Collection~resultCallback***REMOVED*** [callback] The command result callback
 */
 ...
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.findAndModify for a list of options.
 ...
 * @param {object***REMOVED*** query Query object to locate the object to modify.
 * @param {array***REMOVED*** sort If multiple docs match, choose the first one in the specified sort order as the object to manipulate.
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.findAndRemove for a list of options.
 * @param {Collection~resultCallback***REMOVED*** [callback] The command result callback
 ...
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.findOne for a list of options.
 * @param {Collection~resultCallback***REMOVED*** [callback] The command result callback
 */
 ...
 * @method
 * @param {Collection***REMOVED*** a Collection instance.
 * @param {object***REMOVED*** filter Document selection filter.
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.findOneAndDelete for a list of options.
...
function findOneAndDelete(coll, filter, options, callback) {
  // Final options
  const finalOptions = Object.assign({***REMOVED***, options);
 ...
 * @param {Collection***REMOVED*** a Collection instance.
 * @param {object***REMOVED*** filter Document selection filter.
 * @param {object***REMOVED*** replacement Document replacing the matching document.
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.findOneAndReplace for a list of options.
 * @param {Collection~findAndModifyCallback***REMOVED*** [callback] The collection result callback
 */
 ...
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.findOneAndUpdate for a list of options.
 * @param {Collection~findAndModifyCallback***REMOVED*** [callback] The collection result callback
 */
 ...
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.geoHaystackSearch for a list of options.
 * @param {Collection~resultCallback***REMOVED*** [callback] The command result callback
 */
function geoHaystackSearch(coll, x, y, options, callback) {
  ...
  ***REMOVED***;
  ...
  commandObject = decorateCommand(commandObject, options, { readPreference: true, session: true ***REMOVED***);
 ...
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.group for a list of options.
 * @param {Collection~resultCallback***REMOVED*** [callback] The command result callback
...
function group(coll, keys, condition, initial, reduce, finalize, command, options, callback) {
  ...
  ***REMOVED***
    ...
    const scope = reduce != null && reduce._bsontype === 'Code' ? reduce.scope : {***REMOVED***;
 ...
 * @method
 * @param {Collection***REMOVED*** a Collection instance.
 * @param {Object***REMOVED*** [options] Optional settings. See Collection.prototype.indexes for a list of options.
 * @param {Collection~resultCallback***REMOVED*** [callback] The command result callback
 */
function indexes(coll, options, callback) {
  options = Object.assign({***REMOVED***, { full: true ***REMOVED***, options);
 ...
 * @param {Object***REMOVED*** [options] Optional settings. See Collection.prototype.indexExists for a list of options.
 * @param {Collection~resultCallback***REMOVED*** [callback] The command result callback
 */
 ...
 * @method
 * @param {Collection***REMOVED*** a Collection instance.
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.indexInformation for a list of options.
 * @param {Collection~resultCallback***REMOVED*** [callback] The command result callback
 */
 ...
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.insertOne for a list of options.
...
function insertOne(coll, doc, options, callback) {
  if (Array.isArray(doc)) {
    return callback(
      MongoError.create({ message: 'doc parameter must be an object', driver: true ***REMOVED***)
    );
  ***REMOVED***
 ...
 * @method
 * @param {Collection***REMOVED*** a Collection instance.
 * @param {Object***REMOVED*** [options] Optional settings. See Collection.prototype.isCapped for a list of options.
 ...
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.mapReduce for a list of options.
 * @param {Collection~resultCallback***REMOVED*** [callback] The command result callback
 */
function mapReduce(coll, map, reduce, options, callback) {
  ...
  ***REMOVED***
  ...
  if (
    ...
    options.readPreference = 'primary';
    // Decorate command with writeConcern if supported
    applyWriteConcern(mapCommandHash, { db: coll.s.db, collection: coll ***REMOVED***, options);
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  executeCommand(coll.s.db, mapCommandHash, options, (err, result) => {
    ...
    ***REMOVED***
    ...
    if (result.results) {
      ...
      ***REMOVED***
      ...
      return handleCallback(callback, null, { results: result.results, stats: stats ***REMOVED***);
    ***REMOVED***
    ...
    ***REMOVED***
    ...
    handleCallback(callback, err, { collection: collection, stats: stats ***REMOVED***);
  ***REMOVED***);
***REMOVED***
 ...
 * @method
 * @param {Collection***REMOVED*** a Collection instance.
 * @param {Object***REMOVED*** [options] Optional settings. See Collection.prototype.options for a list of options.
 * @param {Collection~resultCallback***REMOVED*** [callback] The results callback
 */
function optionsOp(coll, opts, callback) {
  coll.s.db.listCollections({ name: coll.s.name ***REMOVED***, opts).toArray((err, collections) => {
    if (err) return handleCallback(callback, err);
    if (collections.length === 0) {
      return handleCallback(
        callback,
        MongoError.create({ message: `collection ${coll.s.namespace***REMOVED*** not found`, driver: true ***REMOVED***)
      );
    ***REMOVED***
 ...
 * @method
 * @param {Collection***REMOVED*** a Collection instance.
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.parallelCollectionScan for a list of options.
...
function parallelCollectionScan(coll, options, callback) {
  ...
  ***REMOVED***;
  ...
  executeCommand(coll.s.db, commandObject, options, (err, result) => {
    ...
    options = Object.assign({ explicitlyIgnoreSession: true ***REMOVED***, options);
 ...
 * @method
 * @param {Collection***REMOVED*** a Collection instance.
 * @param {Object***REMOVED*** [options] Optional settings. See Collection.prototype.reIndex for a list of options.
 * @param {Collection~resultCallback***REMOVED*** [callback] The command result callback
 */
function reIndex(coll, options, callback) {
  // Reindex
  const cmd = { reIndex: coll.s.name ***REMOVED***;
...
function removeDocuments(coll, selector, options, callback) {
  if (typeof options === 'function') {
    (callback = options), (options = {***REMOVED***);
  ...
  ***REMOVED***
  ...
  if (selector == null) selector = {***REMOVED***;

  // Build the op
  const op = { q: selector, limit: 0 ***REMOVED***;
  if (options.single) {
    op.limit = 1;
  ***REMOVED*** else if (finalOptions.retryWrites) {
 ...
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.rename for a list of options.
...
function rename(coll, newName, options, callback) {
  ...
  // Build the command
  const renameCollection = `${coll.s.dbName***REMOVED***.${coll.s.name***REMOVED***`;
  const toCollection = `${coll.s.dbName***REMOVED***.${newName***REMOVED***`;
  const dropTarget = typeof options.dropTarget === 'boolean' ? options.dropTarget : false;
  const cmd = { renameCollection: renameCollection, to: toCollection, dropTarget: dropTarget ***REMOVED***;
 ...
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.replaceOne for a list of options.
 ...
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.save for a list of options.
...
function save(coll, doc, options, callback) {
  ...
  const finalOptions = applyWriteConcern(
    Object.assign({***REMOVED***, options),
    { db: coll.s.db, collection: coll ***REMOVED***,
    options
  );
  // Establish if we need to perform an insert or update
  if (doc._id != null) {
    finalOptions.upsert = true;
    return updateDocuments(coll, { _id: doc._id ***REMOVED***, doc, finalOptions, callback);
  ***REMOVED***
 ...
 * @method
 * @param {Collection***REMOVED*** a Collection instance.
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.stats for a list of options.
...
function updateDocuments(coll, selector, document, options, callback) {
  ...
  if (options == null) options = {***REMOVED***;
  ...
  const op = { q: selector, u: document ***REMOVED***;
 ...
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.updateMany for a list of options.
 * @param {Collection~updateWriteOpCallback***REMOVED*** [callback] The command result callback
 */
 ...
 * @param {object***REMOVED*** filter The Filter used to select the document to update
 * @param {object***REMOVED*** update The update operations to be applied to the document
 * @param {object***REMOVED*** [options] Optional settings. See Collection.prototype.updateOne for a list of options.
 * @param {Collection~updateWriteOpCallback***REMOVED*** [callback] The command result callback
 */
